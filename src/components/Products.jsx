  ...
  const handleAddToCart = async (product) => {
    ...
    try {
      ...
      await setDoc(cartItemRef, {
        ...product,
        quantity: 1, // You can allow quantity increment later
      });
  ...
  return (
    <div className="bg-gray-50 text-gray-800 px-6 md:px-20 py-16 scroll-smooth">
      ...
      {categories.map((category) => {
        ...
        return (
          <div key={category} id={id} className="mb-20">
              ...
              {categoryProducts.map((product) => (
                ...
                >
                  <img
                    src={product.image}
                    alt={product.name}
                    className="w-50 h-55 object-cover justify-center mx-auto mt-4 rounded-lg"
                  />
                  <div className="p-5">
